...
<div class="text">
<p>FAMILY CREATE ACCOUNT PAGE</p>
</div>
        ...
        <div id="main">
            ...
            <form class="myform" method="post">
                ...
                <input type="text"  name="cname" class="input" placeholder="Enter your child name"  />
                <br>
                <label class="label">Child Id:</label>
                <input type="number"  name="cid" class="input" placeholder="Enter your child id"  />
                <br>
   ...
   <?php 
     ...
     { 
            ...
            if($password==$cpassword)
            {
                ...
                $query="SELECT * FROM family  WHERE username='$username'";
                $result= mysqli_query($conn, $query);
                 ...
                 {
                      $query="INSERT INTO family (username,password,email,gender,pnum,cname,cid) values( '$username','$password','$email','$gender', '$pnum','$cname','$cid')";
