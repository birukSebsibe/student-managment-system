<?php
 ...
 $query = "SELECT * FROM registeration ORDER BY id DESC";
...
<ul>
    ...
    <li class="active"><a href="admins.php" ><strong>STUDENT INFORMATION</strong></a></li>
...
columns:{
identifier:[0,"id"],
editable:[[1,'username'],[2,'email'],[3,'gender'],[3,'pnum'],[5,'cname'],[6,'cid']]
}, 
restoreButton:false,
