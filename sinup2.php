...
<html>
    <head>
        ...
        <title>Student Sinup Page</title>
...
<div class="text">
<p>STUDENT CREATE ACCOUNT PAGE</p>
</div>
        ...
        <div id="main">
            ...
            <form class="myform" method="post">
                ...
                <br>
                <input type="text"  name="pname" class="input" placeholder="Enter your parent name"  />
                <br>
                <label class="label">parent phone number:</label>
                <br>
                <input type="number"  name="ppnum" class="input" placeholder="Enter your parent phone number"  />
                <br>
                <label class="label">Address:</label>
                <br>
                <input type="text"  name="address" class="input" placeholder="Enter your living address"  />
                <br>
                <input type="submit" name="submitbn"  id="signupb"  value="SignUp"/>
                       <br>
               <a href="index2.php"> <input type="button" id="back_btn"  value="Back "/>
     ...
     { 
            ...
            if($password==$cpassword)
            {
                ...
                $result= mysqli_query($conn, $query);
                 ...
                 {
                      $query="INSERT INTO student (username,password,email, gender,pname,ppnum,address) values( '$username','$password','$email','$gender', '$pname','$ppnum','$address')";
