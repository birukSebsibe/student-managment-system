...
<div class="menu-bar">
    ...
    <li class="active"><a href="#"><strong>CHILD ASSESMENT</strong></a>

    </li>
      <li><a href="paye.php"><strong>PAYMENTT</strong></a></li>
      <li><a href="opening.html"><strong>LOGOUT</strong></a>
      </li>
    </ul>
  </div>
<div class="note"> <p>CHILD ASSESSMENT DISPLAY FORM</p></div>
...
<br><br><br><br><br><br>
  ...
  <center>
    ...
    <form action="" method="POST">
      <input type="text" class="btn" name="id" placeholder="CHILD ID">
       <input type="text" class="btn" name="username" placeholder="CHILD NAME">
   ...
   <?php
        ...
        if (isset($_POST['search'])) {
             $id = $_POST['id'];
             $query = "SELECT * FROM asses WHERE id = '$id' ";
