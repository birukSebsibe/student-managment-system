...
<html>
    <head>
        ...
        <title>Teachers Sinup Page</title>
...
<div class="text">
<p>TEACHERS CREATE ACCOUNT PAGE</p>
</div>
        ...
        <div id="main">
            ...
            <form class="myform" method="post">
                ...
                <br>
                <input type="text"  name="assignedClass" class="input" placeholder="Enter the class you assigned"  />
                <br>
                <input type="submit" name="submitbn"  id="signupb"  value="SignUp"/>
                       <br>
               <a href="index3.php"> <input type="button" id="back_btn"  value="Back "/>
     ...
     { 
            ...
            if($password==$cpassword)
            {
                ...
                $result= mysqli_query($conn, $query);
                 ...
                 {
                      $query="INSERT INTO teacher (username,password,email,gender,pnum,assignedClass) values( '$username','$password','$email','$gender', '$pnum','$assignedClass')";
