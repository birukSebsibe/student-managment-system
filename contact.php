...
<div class="menu-bar">
    ...
    <div class="sub-menu-1">
      ...
      <li ><a href="about.php"><strong>ABOUT</strong></a>
      <div class="sub-menu-2">
          <ul>
            <li><a href="abouts.php">SCHOOL</a></li>
            <li><a href="aboutd.php">DEVELOPERS</a></li>
          </ul>
...
<center>	
	<P><H1>SAINT JOSPHE SCHOOL</H1></P>
	<P><H2>Contact St. Joseph</H2></P>
	<P><H3>Nazareth Community</H3></P>
    <P><H3>P.O Box 406</H3></P>
    <P><H3>nazareth, Ethiopia</H3></P>
    <P><H3>Tel School: 251 (22) 111.3019</H3></P>
    <P><H3>Dr. Sheferaw Mekonen(Heaqdmster)</H3></P>
    <p><h3>Email:sjsadama@telecom.net.et</h3></p>
